...
const Footer = () => {
  return (
    ...
    <motion.div
      ...
      className="bg-blue-900 p-10"
    >
      
      <div className="grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white">
        <div>
          <div className="font-bold mb-6 text-xl">SKILLEX</div>
        ...
        <div>
          <div className="font-bold mb-6 text-xl">Services</div>
        ...
        <div>
          <div className="font-bold mb-6 text-xl">Follow us</div>
          <div className="text-sm mb-4">skillexlearning@gmail.com</div>
          <div className="text-sm">+85511859317</div>
